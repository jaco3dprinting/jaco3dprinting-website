...
export type Product = {
  ...
  materials?: ("PLA" | "PETG" | "TPU" | "ABS" | "ASA" | "PA-Nylon")[];
  multiColour?: boolean;
...

{
...

 {
  ...
  description:
    "Accessory switch Panel Ford Ranger T7 & T8 printed in PETG / ABS / ASA.",
  fullDescription:
...

 {
  ...
  description:
    "Intercooler Grill for the Next Gen Ford Rangers printed in PETG / ABS / ASA.",
  fullDescription:
    "Cover the big opening that the New Rangers have in front of the Intercooler with this Grill Printed in PETG / ABS / ASA, it does not just look good but it also help protect the Intercooler from unwanted damage. It simply just clips into place with 8 clips that will hold it securely.",
  imageCount: 3,
  price: 650,
  materials: ["PETG","ABS","ASA"],
  multiColour: true,
...
{
  id: "raptor-intercooler",
  category: "automotive",
  title: "2022 - 2026 Ford Ranger Raptor Intercooler Grill",
  description:
    "Intercooler Grill for the Next Gen Ford Rangers Raptor printed in PETG / ABS / ASA.",
  fullDescription:
    "Cover the big opening that the New Rangers Raptor have in front of the Intercooler with this Grill Printed in PETG / ABS / ASA, it does not just look good but it also help protect the Intercooler from unwanted damage. It simply just clips into place with 8 clips that will hold it securely.",
  imageCount: 3,
  price: 750,
  materials: ["PETG","ABS","ASA"],
  multiColour: true,
...

 {
  ...
  description:
   "Ford Ranger T6 - T8 Tray Hook Cover printed in PETG / ABS / ASA.",
  fullDescription:
...

{
...

 {
  ...
  title: "Paw Cover",
  description:
    "Flip top style cover for GD6/Ranger Centre console switches printed in PETG / ABS / ASA.",
  fullDescription:
